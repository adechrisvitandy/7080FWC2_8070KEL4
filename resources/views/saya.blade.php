        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{url('/')}}" class="site_title"><i class="fa fa-paw"></i> <span>HOME</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                     ...
                     <li class="dropdown active">
                        ...
                        <li><a href="{{url('sangsiswa')}}"> USER SISWA</a></li> 
                        <li><a href="{{url('sangwali')}}"> USER WALI MURID</a></li>  
                    </li>                           
                        </ul>                            
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                     <a href="{{url('logout')}}"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
